<%-- 
    ...
    Created on : Feb 23, 2022, 10:30:08 AM
    Author     : HuuTrinh
--%>
<!DOCTYPE html>
<nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row" style="box-shadow: 0 0 1px 1px rgb(0 0 0 / 40%);">
