            ...
            <div class="col-md-4 col-sm-4">
                <div class="footer-thumb"> 
                    ...
                    <div class="contact-info">
                        ...
                        <p><i class="fa fa-envelope"></i>benhviennongnghiep1@gmail.com</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 col-sm-4"> 
                <div class="footer-thumb">
                    ...
                    <ul class="social-icon">
                        <li><a class="fab fa-facebook-square" attr="facebook icon"></a></li>
            ...
            <div class="col-md-12 col-sm-12 border-top">
                <div class="col-md-4 col-sm-6">
                    <div class="copyright-text"> 
                        <p>Copyright &copy; 2022 &nbsp |&nbsp Design: HuuTrinh</p>
                        <p><a class="fa fa-envelope"></a> trinh.developer@gmail.com</p>
                    </div>
                </div>
