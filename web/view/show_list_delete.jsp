...
<html>
    ...
    <body>
                                        ...
                                        <c:forEach items="${requestScope.listMR}" var="list">
                                            <tr>
                                                ...
                                                <td class="text-end" width="10%">
                                                    <form method="Post" action="delete_medical_record">
                                                        <input type="hidden" name="id" value="${list.id}"/>
                                                        <!--                                                        <input type="hidden" name="code" value=""/>-->
                                                        <button class="bg-gradient-success text-white"><a onclick="Delete(${list.doctor_id})"> Delete</a></button>
                                                    </form>
        ...
        if (option === true) {
            window.location.href = 'delete_medical_record?id=' + id;
        }
    }
