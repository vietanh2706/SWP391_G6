                    ...
                    <div id="paper-mid">
                        <div class="entry">
                            ...
                            <div class="self">
                                ...
                                <br/><br/>
                                <ul>
<!--                                    <li class="">Address: ${requestScope.patient.address}</li>-->
                        ...
                        <div class="entry">
                            <h2>Height</h2>
                            <p>${requestScope.r.height}</p>
                        </div>

                        <div class="entry">
                            <h2>Weight</h2>
                            <p>${requestScope.r.weight}</p>
                        </div>
                        <div class="entry">
                            <h2>BMI</h2>
                            <p>${requestScope.r.BMI}</p>
                        </div>
                        <div class="entry">
                            <h2>Pulse Rate</h2>
                            <p>${requestScope.r.pulse_rate}</p>
                        </div>
                        <div class="entry">
                            <h2>Blood Pressure</h2>
                            <p>${requestScope.r.blood_pressure}</p>
                        </div>
                        <div class="entry">
                            <h2>Physical Type</h2>
                            <p>${requestScope.r.physical_type}</p>
                        </div>
            ...
            <a class="btn btn-primary btn-lg" style="border-radius: 5px; text-align: center;" href="OptionView"><span style="font-size: 30px">See another records</span></a> 
        </div>
