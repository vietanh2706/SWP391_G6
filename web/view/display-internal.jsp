...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div class="wrapper-mid">
                ...
                <div id="paper">
                    ...
                    <div id="paper-mid">
                        ...
                        <div class="entry">
                            <h2>Blood cycle</h2>
                            <p>${requestScope.r.blood_cycle}</p>
                        </div>

                        <div class="entry">
                            <h2>Respiratory</h2>
                            <p>${requestScope.r.respiratory}</p>
                        </div>
                        <div class="entry">
                            <h2>GI</h2>
                            <p>${requestScope.r.GI}</p>
                        </div>
                        
                        <div class="entry">
                            <h2>Kidneys unary</h2>
                            <p>${requestScope.r.kidneys_unary}</p>
                        </div>
                        
                        <div class="entry">
                            <h2>Musculoskeletal</h2>
                            <p>${requestScope.r.musculoskeletal}</p>
                        </div>
                        
                        <div class="entry">
                            <h2>Neurological</h2>
                            <p>${requestScope.r.neurological}</p>
                        </div>
                        
                        <div class="entry">
                            <h2>Neurospychiaric</h2>
                            <p>${requestScope.r.neurospychiaric}</p>
                        </div>
            ...
            <a class="btn btn-primary btn-lg" style="border-radius: 5px; margin-left:  700px;" href="OptionView"><span style="font-size: 30px">See another records</span></a> 
        </div>
