                                                    ...
                                                    <form class="mb-5" action="update-eye" method="POST" id="contactForm" name="contactForm">
                                                        ...
                                                        <div class="row"> 
                                                            <div class="col-md-6 form-group mb-3">
                                                                ...
                                                                <input type="number" class="form-control" name="vision" id="vision" value="${eye.vision_test}" >
                                                            </div>
                                                            <div class="col-md-6 form-group mb-3">
                                                                <label for="eye1" class="col-form-label" style="font-size: 20px;">Eye Disease</label>
                                                                <input type="text" class="form-control" name="eye1" id="eye1" value="${eye.eye_disease}" >
                                                            </div>
                                                            <div class="col-md-6 form-group mb-3">
                                                                <label for="eye2" class="col-form-label" style="font-size: 20px;">Eye Type</label>
                                                                <input type="text" class="form-control" name="eye2" id="eye2" value="${eye.eye_type}" >
                                                            </div>
                                                            <div class="col-md-12 form-group" style="text-align: center;">
                               
                                                                <input type="submit" value="Edit" id="submit" class="btn btn-group-justified bg-gradient-primary text-white">
                                                                <span class="submitting"></span>
                                                            </div>
                                                        </div>
                                                    </form>
                                            ...
                                            <form class="mb-5" action="update-common" method="post" id="contactForm" name="contactForm">
                                                ...
                                                <div class="row"> 
                                                    <div class="col-md-6 form-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="diagnostic" id="diagnostic" value="${mr.getDiag()}">
                                                    </div>
                                                    <div class="col-md-6 form-group mb-3">
                                                        <label for="conclusion" class="col-form-label" style="font-size: 20px;">Conclusion</label>
                                                        <input type="text" class="form-control" name="conclusion" id="conclusion" value="${mr.getConclusion()}" >
                                                    </div>
                                                    <div class="col-md-12 form-group" style="text-align: center;">
