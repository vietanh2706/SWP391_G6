    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (db.checkUser(username) != null) {
            if (db.checkEmail(username, email) != null) {
                ...
                db.changePass(username, db.toMD5(text));
            } else {
        ...
        new SendMail().sentEmail(db.checkUser(username).getEmail(), "Your passowrd has been reset", "This is your new password " + text);
        request.setAttribute("message", "Your password has been reset, please check your email!");
        request.getRequestDispatcher("view/reset-pass.jsp").forward(request, response);
