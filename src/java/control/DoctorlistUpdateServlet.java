 ...
 * @author asus
 */
@WebServlet(name = "DoctorlistUpdateServlet", urlPatterns = {"/doctorlist-update"})
public class DoctorlistUpdateServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("view/doctorlist_update.jsp").forward(request, response);
    }
