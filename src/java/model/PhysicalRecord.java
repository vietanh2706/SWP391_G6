...
public class PhysicalRecord {
    ...
    public PhysicalRecord(int id, double height, double weight, double BMI, int pulse_rate, int blood_pressure, String physical_type, Type type, String code) {
        this.id = id;
        this.height = height;
        this.weight = weight;
        this.BMI = BMI;
    ...
    public String toString() {
        return "PhysicalRecord{" + "id=" + id + ", height=" + height + ", weight=" + weight + ", BMI=" + BMI + ", pulse_rate=" + pulse_rate + ", blood_pressure=" + blood_pressure + ", physical_type=" + physical_type + ", type=" + type + ", code=" + code + '}';
    }
