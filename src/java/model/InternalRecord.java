...
public class InternalRecord {
    ...
    public InternalRecord(int id, String blood_cycle, String respiratory, String GI, String kidneys_unary, String musculoskeletal, String neurological, String neurospychiaric, Type type, String code) {
        this.id = id;
    ...
    public InternalRecord(String blood_cycle, String respiratory, String GI, String kidneys_unary, String musculoskeletal, String neurological, String neurospychiaric, Type type, String code) {
        this.blood_cycle = blood_cycle;
        this.respiratory = respiratory;
        this.GI = GI;
        this.kidneys_unary = kidneys_unary;
    ...
    public String toString() {
        return "InternalRecord{" + "id=" + id + ", blood_cycle=" + blood_cycle + ", respiratory=" + respiratory + ", GI=" + GI + ", kidneys_unary=" + kidneys_unary + ", musculoskeletal=" + musculoskeletal + ", neurological=" + neurological + ", neurospychiaric=" + neurospychiaric + ", type=" + type + ", code=" + code + '}';
    }
