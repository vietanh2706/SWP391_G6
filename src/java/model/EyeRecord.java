...
public class EyeRecord {
    ...
    public EyeRecord(int id, String vision_test, String eye_disease, String eye_type, Type type, String code) {
        this.id = id;
    ...
    public String toString() {
        return "EyeRecord{" + "id=" + id + ", vision_test=" + vision_test + ", eye_disease=" + eye_disease + ", eye_type=" + eye_type + ", type=" + type + ", code=" + code + '}';
    }
